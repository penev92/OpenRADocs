...
| BrightSequence | bright | String | SequenceReference (imageReference: Image; prefix: False; allowNullImage: False; dictionaryReference: None) |  |
| DimSequence | dim | String | SequenceReference (imageReference: Image; prefix: False; allowNullImage: False; dictionaryReference: None) |  |
| Palette | effect | String | PaletteReference (isPlayerPalette: False) |  |
...
| Sequences | idle | Collection of String | SequenceReference (imageReference: Image; prefix: False; allowNullImage: True; dictionaryReference: None) | Loop a randomly chosen sequence of Image from this list while this projectile is moving. |
| Palette | effect | String | PaletteReference (playerPaletteReferenceSwitch: IsPlayerPalette) | The palette used to draw this projectile. |
...
| TrailSequences | idle | Collection of String | SequenceReference (imageReference: TrailImage; prefix: False; allowNullImage: True; dictionaryReference: None) | Loop a randomly chosen sequence of TrailImage from this list while this projectile is moving. |
...
| TrailPalette | effect | String | PaletteReference (playerPaletteReferenceSwitch: TrailUsePlayerPalette) | Palette used to render the trail sequence. |
...
| HitAnimSequence | idle | String | SequenceReference (imageReference: HitAnim; prefix: False; allowNullImage: True; dictionaryReference: None) | Sequence of impact animation to use. |
| HitAnimPalette | effect | String | PaletteReference (isPlayerPalette: False) |  |
| LaunchEffectImage |  | String |  | Image containing launch effect sequence. |
| LaunchEffectSequence |  | String | SequenceReference (imageReference: LaunchEffectImage; prefix: False; allowNullImage: True; dictionaryReference: None) | Launch effect sequence to play. |
| LaunchEffectPalette | effect | String | PaletteReference (isPlayerPalette: False) | Palette to use for launch effect. |
...
| Sequences | idle | Collection of String | SequenceReference (imageReference: Image; prefix: False; allowNullImage: True; dictionaryReference: None) | Loop a randomly chosen sequence of Image from this list while this projectile is moving. |
| Palette | effect | String | PaletteReference (playerPaletteReferenceSwitch: IsPlayerPalette) | Palette used to render the projectile sequence. |
| IsPlayerPalette | False | Boolean |  | Palette is a player palette BaseName |
| Shadow | False | Boolean |  | Does this projectile have a shadow? |
| ShadowColor | 0000008C | Color (RRGGBB[AA] notation) |  | Color to draw shadow if Shadow is true. |
...
| Property | Default Value | Type | Attributes | Description |
| -------- | ------------- | ---- | ---------- | ----------- |
| Explosions |  | Collection of String | SequenceReference (imageReference: Image; prefix: False; allowNullImage: True; dictionaryReference: None) | List of explosion sequences that can be used. |
| Image | explosion | String |  | Image containing explosion effect sequence. |
| ExplosionPalette | effect | String | PaletteReference (playerPaletteReferenceSwitch: UsePlayerPalette) | Palette to use for explosion effect. |
...
| AddsResourceType |  | String | Require | Will this splatter resources and which? |
| ValidTargets | Ground, Water | Collection of TargetableType |  | What types of targets are affected. |
| InvalidTargets |  | Collection of TargetableType |  | What types of targets are unaffected. Overrules ValidTargets. |
| ValidRelationships | Enemy, Neutral, Ally | PlayerRelationship |  | What player relationships are affected. |
| AffectsParent | False | Boolean |  | Can this warhead affect the actor that fired it. |
...
| Dimensions | 0,0 | 2D Cell Vector | Require | Size of the cluster footprint |
| Footprint |  | String | Require | Cluster footprint. Cells marked as X will be attacked. Cells marked as x will be attacked randomly until RandomClusterCount is reached. |
| ValidTargets | Ground, Water | Collection of TargetableType |  | What types of targets are affected. |
| InvalidTargets |  | Collection of TargetableType |  | What types of targets are unaffected. Overrules ValidTargets. |
| ValidRelationships | Enemy, Neutral, Ally | PlayerRelationship |  | What player relationships are affected. |
| AffectsParent | False | Boolean |  | Can this warhead affect the actor that fired it. |
